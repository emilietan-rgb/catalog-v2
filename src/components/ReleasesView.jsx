...
const RELEASES = [
  { id:1,  title:'Lueurs',               artist:'Aurélie Dumas',     trackCount:1,  upc:'196871000101', status:'draft',    type:'music', subtype:null,       info:null,                    account:'Lumière Records', releaseDate:'—',          releaseTime:null,  coverImage:'https://images.unsplash.com/photo-1667833966178-f98135a582f8?q=80&w=400', tracklist:[{id:1,title:'Lueurs',version:'Original',isrc:'FR-ADM-26-001',duration:'3:24',status:'live'}] },
...
const STATUS_OPTIONS = ['Delivered', 'Under review', 'Action required', 'Sent to DSPs', 'Taken down', 'Draft']
