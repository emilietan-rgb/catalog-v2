...
function getInfoColor(status, info) {
  ...
  if (info === 'Copyright alert' || info === 'Locked' || info === 'Delivery error') return '#0F1012'
  return '#9aa0b0'
}
...
function getInfoIcon(info) {
  ...
  if (info === 'Copyright alert' || info === 'Locked' || info === 'Delivery error') return 'alert'
  return undefined
}
...
function getInfoVariant(status, info) {
  ...
  if (info === 'Copyright alert' || info === 'Locked' || info === 'Delivery error') return 'action'
  return undefined
}
